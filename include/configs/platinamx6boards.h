...
#define CONFIG_EXTRA_ENV_SETTINGS \
  ...
  "bootcmd=run readmac;sf probe 0;sf read ${fdt_addr} 0x00080000 ${sz_fdt};sf read ${loadaddr} 0x00100000 ${sz_kernel};sf read ${initrd_addr} 0x00300000 ${sz_initrd};bootz ${loadaddr} - ${fdt_addr}\0" \
  "bootdelay=10\0" \
